        ...
        <main className="flex-1 overflow-y-auto p-4 lg:p-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Workflow Builder</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <CardHeader>
                  <CardTitle className="text-xl text-gray-900 dark:text-white">Lead Nurturing Workflows</CardTitle>
              ...
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <CardHeader>
                  <CardTitle className="text-xl text-gray-900 dark:text-white">Marketing Automation</CardTitle>
              ...
              <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <CardHeader>
                  <CardTitle className="text-xl text-gray-900 dark:text-white">Client Onboarding</CardTitle>
            ...
            <Card className="bg-gradient-to-r from-primary-50 to-purple-50 dark:from-primary-900/20 dark:to-purple-900/20 border-primary-200 dark:border-primary-800">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-gray-900 dark:text-white mb-2">Visual Workflow Builder</CardTitle>
                <CardDescription className="text-lg">
                  Drag-and-drop interface for creating complex automation sequences
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-8">
                <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-inner">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    <div>
                      ...
                      <h4 className="font-medium text-gray-900 dark:text-white mb-2">Set Triggers</h4>
                    ...
                    <div>
                      ...
                      <h4 className="font-medium text-gray-900 dark:text-white mb-2">Add Conditions</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div>
                      ...
                      <h4 className="font-medium text-gray-900 dark:text-white mb-2">Execute Actions</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
