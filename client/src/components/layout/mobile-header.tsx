...
export default function MobileHeader() {
  ...
  return (
    <header className="bg-white dark:bg-card border-b border-border px-4 py-3 flex items-center justify-between">
      {/* Logo and Brand */}
            ...
            <div className="flex flex-col h-full">
                      ...
                      >
                        <div className={`
                          ...
                          ${active 
                            ...
                            : 'text-muted-foreground dark:text-muted-foreground hover:bg-card dark:hover:bg-card'
                          }
                        `}>
              ...
              <div className="p-4 border-t border-border space-y-2">
                <Link href="/settings" onClick={() => setIsOpen(false)}>
                  <div className="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium text-muted-foreground dark:text-muted-foreground hover:bg-card dark:hover:bg-card transition-colors">
